...
/**
 * Clase objeto Citas donde se crean lo necesario para poder trabajar con la
 * información necesaria en la aplicación facilitando registros de citas
 * 
...
public class Citas {
	...
	public Citas(String nombre, String apellidos, int edad, String email, int telefono, String sexo, String box,
			String observaciones, String fecha, String DNI) {
		super();
