...
public class ControllerEstadisticas {
  ...
  */
 	...
 	private void StackedBarChart() {
 		...
 		for(Citas c: Estadisticas) {
 			// if que se encarga de verificar si el año esta ya dentro de la lista auxiliar, si no lo añade
 			if(!contadorAn.contains(c.getFecha().substring(0,4))) {
 				...
 				// for auxiliar para volver a recorrer los registros de nuevo, pero ahora contará los meses de los años 
