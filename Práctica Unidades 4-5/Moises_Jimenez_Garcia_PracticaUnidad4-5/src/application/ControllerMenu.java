...
public class ControllerMenu {
	...
	/**
	 * Inicio de sesión donde si el usuario pulsa entrar valida que los campos
	 * usuario contraseña son correctos Si son correctos, abre modal de ANTES DE
	 * EMPEZAR,al hacer ok cierra esa y la del usuario. De lo contrario abre un
	 * modal de error llamando al método utilidades donde he generado métodos
	 ...
	 *         propia clase en el método de abrirPendientes donde verificamos que
	 *         opción tiene seleccionada
	 * 
	 * 
	 */
